(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (holding white_block_1)) (sometime-before (holding white_block_1) (clear black_block_1)) (sometime (clear yellow_block_1)) (sometime-before (clear yellow_block_1) (on black_block_1 orange_block_1)) (sometime (not (clear black_block_2))) (sometime (not (ontable yellow_block_1))))
