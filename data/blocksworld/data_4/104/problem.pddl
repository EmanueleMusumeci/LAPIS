(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (not (clear purple_block_1))) (sometime-after (not (clear purple_block_1)) (holding red_block_1)) (sometime (holding grey_block_1)) (sometime (not (clear grey_block_1))) (sometime (holding yellow_block_2)) (sometime-after (holding yellow_block_2) (or (holding grey_block_1) (not (clear grey_block_1)))))
