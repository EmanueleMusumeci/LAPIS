(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   purple_block_1 red_block_1 - block
 )
 ...
 (:action unstack
  ...
  :effect (and (holding ?obj) (clear ?underobj) (not (on ?obj ?underobj)) (not (clear ?obj)) (not (handempty)) (when (not (or (= ?underobj purple_block_1) (and (clear purple_block_1) (not (= ?obj purple_block_1))))) (hold_0)) (when (and (not (or (= ?underobj purple_block_1) (and (clear purple_block_1) (not (= ?obj purple_block_1))))) (not (or (= ?obj red_block_1) (holding red_block_1)))) (not (hold_1))) (when (or (= ?obj red_block_1) (holding red_block_1)) (hold_1)) (increase (total-cost) 1)))
)
