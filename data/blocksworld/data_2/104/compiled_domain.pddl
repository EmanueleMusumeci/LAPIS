(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   red_block_1 purple_block_1 grey_block_1 - block
 )
 ...
 (:action pickup
  ...
  :effect (and (holding ?obj) (not (clear ?obj)) (not (ontable ?obj)) (not (handempty)) (when (not (and (clear purple_block_1) (not (= ?obj purple_block_1)))) (hold_0)) (when (and (not (and (clear purple_block_1) (not (= ?obj purple_block_1)))) (not (or (= ?obj red_block_1) (holding red_block_1)))) (not (hold_1))) (when (or (= ?obj red_block_1) (holding red_block_1)) (hold_1)) (when (or (= ?obj grey_block_1) (holding grey_block_1)) (hold_2)) (increase (total-cost) 1)))
 (:action putdown
  :parameters ( ?obj - block)
 ...
 (:action unstack
  ...
  :effect (and (holding ?obj) (clear ?underobj) (not (on ?obj ?underobj)) (not (clear ?obj)) (not (handempty)) (when (not (or (= ?underobj purple_block_1) (and (clear purple_block_1) (not (= ?obj purple_block_1))))) (hold_0)) (when (and (not (or (= ?underobj purple_block_1) (and (clear purple_block_1) (not (= ?obj purple_block_1))))) (not (or (= ?obj red_block_1) (holding red_block_1)))) (not (hold_1))) (when (or (= ?obj red_block_1) (holding red_block_1)) (hold_1)) (when (or (= ?obj grey_block_1) (holding grey_block_1)) (hold_2)) (increase (total-cost) 1)))
)
