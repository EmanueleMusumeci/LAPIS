(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   black_block_1 white_block_1 orange_block_1 yellow_block_1 - block
 )
 ...
 (:action pickup
  ...
  :effect (and (holding ?obj) (not (clear ?obj)) (not (ontable ?obj)) (not (handempty)) (when (or (= ?obj white_block_1) (holding white_block_1)) (hold_0)) (when (and (clear black_block_1) (not (= ?obj black_block_1))) (seen_psi_1)) (when (and (clear yellow_block_1) (not (= ?obj yellow_block_1))) (hold_2)) (increase (total-cost) 1)))
 (:action putdown
  :parameters ( ?obj - block)
  ...
  :effect (and (clear ?obj) (handempty) (ontable ?obj) (not (holding ?obj)) (when (and (holding white_block_1) (not (= ?obj white_block_1))) (hold_0)) (when (or (= ?obj black_block_1) (clear black_block_1)) (seen_psi_1)) (when (or (= ?obj yellow_block_1) (clear yellow_block_1)) (hold_2)) (increase (total-cost) 1)))
 (:action stack
