(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (on grey_block_1 white_block_1)) (sometime (ontable white_block_1)) (sometime-after (ontable white_block_1) (or (on white_block_1 green_block_2) (not (clear green_block_2)))))
