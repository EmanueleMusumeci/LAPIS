(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (and (not (ontable yellow_block_2)) (not (ontable yellow_block_1)))) (sometime (or (not (ontable yellow_block_1)) (holding yellow_block_1))) (sometime (ontable grey_block_1)) (sometime-after (ontable grey_block_1) (or (on purple_block_1 yellow_block_2) (holding yellow_block_2))))
