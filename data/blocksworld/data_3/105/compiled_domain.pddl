(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   blue_block_1 red_block_1 brown_block_1 brown_block_2 grey_block_1 - block
 )
 ...
 (:action pickup
  ...
  :precondition (and (clear ?obj) (ontable ?obj) (handempty) (not (and (ontable brown_block_2) (not (= ?obj brown_block_2)))))
 ...
 (:action putdown
  :parameters ( ?obj - block)
  :precondition (and (holding ?obj) (not (or (= ?obj brown_block_2) (ontable brown_block_2))))
