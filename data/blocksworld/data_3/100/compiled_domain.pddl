(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   purple_block_1 green_block_2 green_block_1 black_block_1 black_block_2 - block
 )
