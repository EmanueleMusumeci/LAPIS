(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (and (not (ontable purple_block_1)) (holding green_block_1))) (sometime (not (on purple_block_1 black_block_2))) (sometime-after (not (on purple_block_1 black_block_2)) (holding black_block_1)) (sometime (not (on green_block_2 black_block_2))))
