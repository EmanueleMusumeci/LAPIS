(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (ontable black_block_2)) (sometime-before (ontable black_block_2) (or (not (ontable white_block_2)) (not (clear red_block_1)))) (sometime (not (clear red_block_1))) (sometime (not (clear white_block_1))))
