(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   purple_block_1 black_block_1 yellow_block_2 yellow_block_1 grey_block_1 - block
 )
 ...
 (:action pickup
  ...
  :precondition (and (clear ?obj) (ontable ?obj) (handempty) (not (and (ontable purple_block_1) (not (= ?obj purple_block_1)))) (or (not (and (ontable black_block_1) (not (= ?obj black_block_1)))) (seen_psi_5)))
  :effect (and (holding ?obj) (not (clear ?obj)) (not (ontable ?obj)) (not (handempty)) (when (and (not (and (ontable yellow_block_2) (not (= ?obj yellow_block_2)))) (not (and (ontable yellow_block_1) (not (= ?obj yellow_block_1))))) (hold_0)) (when (or (not (and (ontable yellow_block_1) (not (= ?obj yellow_block_1)))) (= ?obj yellow_block_1) (holding yellow_block_1)) (hold_1)) (when (and (ontable grey_block_1) (not (= ?obj grey_block_1))) (hold_2)) (when (and (ontable grey_block_1) (not (= ?obj grey_block_1)) (not (or (on purple_block_1 yellow_block_2) (= ?obj yellow_block_2) (holding yellow_block_2)))) (not (hold_3))) (when (or (on purple_block_1 yellow_block_2) (= ?obj yellow_block_2) (holding yellow_block_2)) (hold_3)) (when (and (ontable black_block_1) (not (= ?obj black_block_1))) (hold_4)) (when (or (on purple_block_1 grey_block_1) (not (and (ontable yellow_block_1) (not (= ?obj yellow_block_1))))) (seen_psi_5)) (increase (total-cost) 1)))
 (:action putdown
  :parameters ( ?obj - block)
  :precondition (and (holding ?obj) (not (or (= ?obj purple_block_1) (ontable purple_block_1))) (or (not (or (= ?obj black_block_1) (ontable black_block_1))) (seen_psi_5)))
  :effect (and (clear ?obj) (handempty) (ontable ?obj) (not (holding ?obj)) (when (and (not (or (= ?obj yellow_block_2) (ontable yellow_block_2))) (not (or (= ?obj yellow_block_1) (ontable yellow_block_1)))) (hold_0)) (when (or (not (or (= ?obj yellow_block_1) (ontable yellow_block_1))) (and (holding yellow_block_1) (not (= ?obj yellow_block_1)))) (hold_1)) (when (or (= ?obj grey_block_1) (ontable grey_block_1)) (hold_2)) (when (and (or (= ?obj grey_block_1) (ontable grey_block_1)) (not (or (on purple_block_1 yellow_block_2) (and (holding yellow_block_2) (not (= ?obj yellow_block_2)))))) (not (hold_3))) (when (or (on purple_block_1 yellow_block_2) (and (holding yellow_block_2) (not (= ?obj yellow_block_2)))) (hold_3)) (when (or (= ?obj black_block_1) (ontable black_block_1)) (hold_4)) (when (or (on purple_block_1 grey_block_1) (not (or (= ?obj yellow_block_1) (ontable yellow_block_1)))) (seen_psi_5)) (increase (total-cost) 1)))
 (:action stack
  :parameters ( ?obj - block ?underobj - block)
  :precondition (and (clear ?underobj) (holding ?obj))
  :effect (and (handempty) (clear ?obj) (on ?obj ?underobj) (not (clear ?underobj)) (not (holding ?obj)) (when (or (not (ontable yellow_block_1)) (and (holding yellow_block_1) (not (= ?obj yellow_block_1)))) (hold_1)) (when (and (ontable grey_block_1) (not (or (and (= ?obj purple_block_1) (= ?underobj yellow_block_2)) (on purple_block_1 yellow_block_2) (and (holding yellow_block_2) (not (= ?obj yellow_block_2)))))) (not (hold_3))) (when (or (and (= ?obj purple_block_1) (= ?underobj yellow_block_2)) (on purple_block_1 yellow_block_2) (and (holding yellow_block_2) (not (= ?obj yellow_block_2)))) (hold_3)) (when (or (and (= ?obj purple_block_1) (= ?underobj grey_block_1)) (on purple_block_1 grey_block_1) (not (ontable yellow_block_1))) (seen_psi_5)) (increase (total-cost) 1)))
 (:action unstack
  :parameters ( ?obj - block ?underobj - block)
  :precondition (and (on ?obj ?underobj) (clear ?obj) (handempty))
  :effect (and (holding ?obj) (clear ?underobj) (not (on ?obj ?underobj)) (not (clear ?obj)) (not (handempty)) (when (or (not (ontable yellow_block_1)) (= ?obj yellow_block_1) (holding yellow_block_1)) (hold_1)) (when (and (ontable grey_block_1) (not (or (and (on purple_block_1 yellow_block_2) (not (and (= ?obj purple_block_1) (= ?underobj yellow_block_2)))) (= ?obj yellow_block_2) (holding yellow_block_2)))) (not (hold_3))) (when (or (and (on purple_block_1 yellow_block_2) (not (and (= ?obj purple_block_1) (= ?underobj yellow_block_2)))) (= ?obj yellow_block_2) (holding yellow_block_2)) (hold_3)) (when (or (and (on purple_block_1 grey_block_1) (not (and (= ?obj purple_block_1) (= ?underobj grey_block_1)))) (not (ontable yellow_block_1))) (seen_psi_5)) (increase (total-cost) 1)))
)
