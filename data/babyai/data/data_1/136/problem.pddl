(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_door_1 blue_door_1 grey_door_1 blue_door_2 - door
 ...
 (:constraints (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (agentinroom room_3)))
