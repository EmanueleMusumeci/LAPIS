(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoobject
  ...
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?obj) (when (or (objectinroom green_ball_1 room_3) (= ?obj grey_box_1)) (hold_0)) (increase (total-cost) 1)))
 (:action gotoempty
  :parameters ()
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ empty) (when (objectinroom green_ball_1 room_3) (hold_0)) (increase (total-cost) 1)))
 (:action gotodoor
 ...
 (not (blocked ?door ?o ?room1))))
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?door) (when (objectinroom green_ball_1 room_3) (hold_0)) (increase (total-cost) 1)))
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (objectinroom green_ball_1 room_3) (hold_0)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (or (and (objectinroom green_ball_1 room_3) (not (and (= ?obj green_ball_1) (= ?room room_3)))) (and (at_ grey_box_1) (not (= ?obj grey_box_1)))) (hold_0)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (= ?obj green_ball_1) (= ?room room_3)) (objectinroom green_ball_1 room_3) (= ?obj grey_box_1) (at_ grey_box_1)) (hold_0)) (increase (total-cost) 1)))
 (:action toggle
