(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   green_door_1 blue_door_1 red_door_1 - door
   yellow_ball_1 yellow_ball_2 purple_ball_1 yellow_ball_3 red_ball_2 red_ball_1 green_ball_1 - ball
   yellow_box_1 - box
 )
 ...
 (and (objectcolor ?v yellowtype) (objectinroom ?v room_3) (agentinroom room_3) (at_ ?v))) (hold_0)))
