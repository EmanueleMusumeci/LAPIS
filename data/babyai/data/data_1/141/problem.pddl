(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 green_ball_1 red_ball_1 blue_ball_1 - ball
   red_box_1 red_box_2 grey_box_1 green_box_1 - box
 )
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-after (not (locked green_door_1)) (or (carrying red_ball_1) (at_ red_box_1))))
