(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 yellow_door_1 red_door_1 - door
   yellow_ball_1 red_ball_1 green_ball_2 green_ball_1 blue_ball_1 - ball
 ...
 (and (objectcolor ?d yellowtype) (at_ ?d) (not (locked ?d)))) (hold_0) (hold_1)))
