(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_2 purple_ball_1 grey_ball_1 red_ball_1 - ball
   purple_box_1 yellow_box_1 green_box_2 green_box_1 - box
 )
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (carrying purple_ball_1)))
