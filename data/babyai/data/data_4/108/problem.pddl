(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_2 purple_box_1 grey_box_1 green_box_1 - box
   blue_ball_2 blue_ball_1 red_ball_1 blue_ball_3 - ball
 )
 ...
 (:constraints (sometime (or (not (emptyhands)) (objectinroom blue_ball_1 room_2))) (always (not (agentinroom room_2))) (always (locked green_door_1)) (sometime (not (locked green_door_2))) (sometime-after (not (locked green_door_2)) (carrying blue_ball_1)))
