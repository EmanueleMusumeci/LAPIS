(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (not (locked yellow_door_1))) (always (locked red_door_1)) (sometime (or (not (locked yellow_door_1)) (carrying blue_box_1))))
