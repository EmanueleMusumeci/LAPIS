(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_ball_1 blue_ball_2 blue_ball_1 yellow_ball_1 - ball
   red_box_2 red_box_1 yellow_box_1 grey_box_1 - box
 )
 ...
 (:constraints (sometime (not (emptyhands))) (always (not (agentinroom room_3))) (sometime (carrying red_box_2)) (always (locked purple_door_1)))
