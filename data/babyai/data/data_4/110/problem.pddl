(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_1 - ball
   blue_box_1 purple_box_1 yellow_box_1 grey_box_1 green_box_1 blue_box_2 green_box_2 - box
 )
 ...
 (:constraints (sometime (not (emptyhands))) (sometime-before (not (emptyhands)) (or (agentinroom room_1) (objectinroom empty room_2))) (always (locked blue_door_1)) (sometime (carrying green_box_1)) (sometime (at_ red_door_1)))
