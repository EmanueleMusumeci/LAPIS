(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 green_door_1 - door
   grey_ball_1 - ball
   blue_box_1 purple_box_1 yellow_box_1 grey_box_1 blue_box_2 green_box_2 - box
 )
 ...
 (and (objectcolor ?v greytype) (carrying ?v) (agentinroom room_2))) (hold_0) (hold_2) (hold_3)))
