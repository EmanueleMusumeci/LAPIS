(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_3 purple_ball_1 grey_ball_1 grey_ball_2 red_ball_1 yellow_ball_1 - ball
   blue_box_1 yellow_box_1 - box
 )
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (not (emptyhands))) (always (locked blue_door_1)) (sometime (at_ grey_door_1)) (sometime-before (at_ grey_door_1) (at_ yellow_ball_1)) (sometime (not (emptyhands))))
