(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   green_door_1 blue_door_1 - door
   yellow_box_2 grey_box_1 green_box_1 - box
 ...
 (and (objectcolor ?v greytype) (objectinroom ?v room_3) (agentinroom room_3) (at_ ?v))) (hold_0) (hold_1) (hold_2) (hold_3) (hold_4)))
