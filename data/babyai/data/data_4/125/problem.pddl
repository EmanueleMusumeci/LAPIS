(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_2 yellow_box_1 grey_box_1 green_box_1 green_box_2 - box
   blue_ball_2 blue_ball_1 yellow_ball_1 - ball
 )
 ...
 (:constraints (sometime (or (not (locked purple_door_1)) (at_ purple_door_1))) (sometime (and (not (emptyhands)) (carrying green_box_2))) (sometime (at_ yellow_box_1)) (sometime (locked red_door_1)) (sometime-after (locked red_door_1) (not (emptyhands))))
