(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_ball_1 blue_ball_1 yellow_ball_2 yellow_ball_1 - ball
   yellow_box_1 grey_box_1 green_box_1 grey_box_2 - box
 )
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (carrying grey_box_2)) (sometime (at_ blue_door_3)) (sometime (and (agentinroom room_3) (objectinroom yellow_ball_1 room_3))))
