(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_ball_1 purple_ball_1 grey_ball_1 grey_ball_2 blue_ball_1 red_ball_1 purple_ball_2 - ball
   grey_box_1 - box
 )
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (agentinroom room_1)) (sometime (not (locked purple_door_2))) (sometime-before (not (locked purple_door_2)) (or (agentinroom room_3) (carrying purple_ball_2))) (sometime (and (not (locked grey_door_1)) (carrying purple_ball_2))) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (or (carrying green_ball_1) (objectinroom blue_ball_1 room_1))))
