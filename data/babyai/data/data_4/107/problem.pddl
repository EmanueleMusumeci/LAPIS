(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_3 purple_ball_1 grey_ball_1 grey_ball_2 red_ball_1 - ball
   blue_box_1 red_box_1 green_box_1 - box
 )
 ...
 (:constraints (sometime (and (objectinroom red_ball_1 room_4) (agentinroom room_1))) (sometime (not (locked purple_door_1))) (sometime-before (not (locked purple_door_1)) (or (carrying red_box_1) (at_ red_box_1))) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (or (carrying grey_ball_1) (not (locked green_door_1)))) (sometime (not (locked grey_door_1))))
