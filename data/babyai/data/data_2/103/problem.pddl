(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 purple_ball_1 grey_ball_2 red_ball_1 grey_ball_3 grey_ball_1 - ball
 )
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (not (emptyhands))) (always (locked blue_door_1)))
