(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_box_1 yellow_box_1 grey_box_1 green_box_1 red_box_1 green_box_2 - box
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (or (not (emptyhands)) (agentinroom room_1))) (sometime (not (locked green_door_1))) (sometime-after (not (locked green_door_1)) (or (carrying grey_ball_2) (not (locked red_door_1)))))
