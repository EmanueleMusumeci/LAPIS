(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 green_ball_1 blue_ball_2 blue_ball_1 - ball
   yellow_box_1 red_box_2 grey_box_1 red_box_1 - box
 )
 ...
 (:constraints (sometime (not (emptyhands))) (always (not (agentinroom room_3))))
