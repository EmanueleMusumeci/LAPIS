(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_1 purple_box_1 green_box_1 green_box_2 - box
   purple_ball_1 red_ball_1 grey_ball_1 - ball
 )
 ...
 (and (objectcolor ?d greentype) (at_ ?d) (not (locked ?d)))) (hold_0) (hold_2) (hold_3)))
