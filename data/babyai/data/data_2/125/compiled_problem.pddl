(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   green_door_1 red_door_1 blue_door_1 - door
   yellow_ball_1 blue_ball_2 blue_ball_1 - ball
   yellow_box_1 yellow_box_2 grey_box_1 green_box_2 - box
 )
 ...
 (and (objectcolor ?v greytype) (objectinroom ?v room_3) (agentinroom room_3) (at_ ?v))) (hold_0) (hold_1)))
