(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_1 yellow_box_2 grey_box_1 green_box_1 green_box_2 - box
 )
 ...
 (:constraints (sometime (or (not (locked purple_door_1)) (at_ purple_door_1))) (sometime (and (not (emptyhands)) (carrying green_box_1))))
