(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (and (locked blue_door_2) (not (or (not (emptyhands)) (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))))) (not (hold_1))) (when (or (not (emptyhands)) (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))) (hold_1)) (when (or (= ?room2 room_3) (and (agentinroom room_3) (not (= ?room1 room_3))) (objectinroom blue_box_1 room_3)) (hold_2)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (hold_1) (when (or (agentinroom room_3) (and (objectinroom blue_box_1 room_3) (not (and (= ?obj blue_box_1) (= ?room room_3))))) (hold_2)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (locked blue_door_2) (not (agentinroom room_2))) (not (hold_1))) (when (agentinroom room_2) (hold_1)) (when (or (agentinroom room_3) (and (= ?obj blue_box_1) (= ?room room_3)) (objectinroom blue_box_1 room_3)) (hold_2)) (increase (total-cost) 1)))
 (:action toggle
  :parameters ( ?door - door)
  :precondition (and (at_ ?door))
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (or (and (not (locked ?door)) (= ?door blue_door_2)) (and (locked blue_door_2) (not (and (locked ?door) (= ?door blue_door_2))))) (hold_0)) (when (and (or (and (not (locked ?door)) (= ?door blue_door_2)) (and (locked blue_door_2) (not (and (locked ?door) (= ?door blue_door_2))))) (not (or (not (emptyhands)) (agentinroom room_2)))) (not (hold_1))) (increase (total-cost) 1)))
)
