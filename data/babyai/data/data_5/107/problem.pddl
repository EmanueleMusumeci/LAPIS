(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_ball_1 grey_ball_1 red_ball_1 grey_ball_3 grey_ball_2 - ball
   red_box_1 blue_box_1 green_box_1 - box
 )
 ...
 (:constraints (sometime (and (objectinroom blue_box_1 room_4) (at_ red_box_1))) (sometime (locked purple_door_1)) (sometime-after (locked purple_door_1) (or (objectinroom blue_box_1 room_1) (agentinroom room_1))) (sometime (at_ grey_ball_3)) (sometime-before (at_ grey_ball_3) (or (not (locked grey_door_1)) (agentinroom room_3))) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (carrying grey_ball_2)) (sometime (and (at_ green_door_1) (not (emptyhands)))))
