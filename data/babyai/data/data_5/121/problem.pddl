(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 yellow_door_1 grey_door_1 purple_door_2 - door
   yellow_box_1 green_box_2 yellow_box_2 purple_box_1 blue_box_1 green_box_1 - box
   green_ball_1 yellow_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (locked yellow_door_1))) (sometime (or (not (emptyhands)) (agentinroom room_3))) (sometime (objectinroom green_ball_1 room_3)) (sometime (not (emptyhands))) (sometime (and (agentinroom room_4) (not (locked yellow_door_1)))))
