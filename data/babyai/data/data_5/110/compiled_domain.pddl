(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   empty - empty_0
   grey_box_1 purple_box_1 blue_box_1 - box
   room_1 room_4 - room
   red_door_1 blue_door_1 green_door_1 - door
 )
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (objectinroom blue_box_1 room_4) (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1)))) (seen_psi_1)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands) (seen_psi_1))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (hold_0) (when (or (and (objectinroom blue_box_1 room_4) (not (and (= ?obj blue_box_1) (= ?room room_4)))) (agentinroom room_1)) (seen_psi_1)) (when (or (= ?obj purple_box_1) (carrying purple_box_1)) (hold_3)) (when (or (not (locked red_door_1)) (= ?obj grey_box_1) (carrying grey_box_1)) (hold_4)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (= ?obj blue_box_1) (= ?room room_4)) (objectinroom blue_box_1 room_4) (agentinroom room_1)) (seen_psi_1)) (when (and (carrying purple_box_1) (not (= ?obj purple_box_1))) (hold_3)) (when (or (not (locked red_door_1)) (and (carrying grey_box_1) (not (= ?obj grey_box_1)))) (hold_4)) (increase (total-cost) 1)))
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (not (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1)))))) (hold_2)) (when (or (not (or (and (not (locked ?door)) (= ?door red_door_1)) (and (locked red_door_1) (not (and (locked ?door) (= ?door red_door_1)))))) (carrying grey_box_1)) (hold_4)) (increase (total-cost) 1)))
)
