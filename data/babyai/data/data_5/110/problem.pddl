(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_1 blue_box_2 green_box_2 grey_box_1 purple_box_1 blue_box_1 green_box_1 - box
   grey_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (emptyhands))) (sometime-before (not (emptyhands)) (or (objectinroom blue_box_1 room_4) (agentinroom room_1))) (sometime (not (locked green_door_1))) (always (locked blue_door_1)) (sometime (carrying purple_box_1)) (sometime (or (not (locked red_door_1)) (carrying grey_box_1))))
