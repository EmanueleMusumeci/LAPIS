(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   blue_door_1 blue_door_2 green_door_1 - door
   yellow_box_1 grey_box_2 grey_box_1 - box
   purple_ball_1 blue_ball_1 yellow_ball_1 - ball
 )
 ...
 (and (objectcolor ?v yellowtype) (at_ ?v))) (hold_0) (hold_1) (hold_2) (hold_3) (hold_4)))
