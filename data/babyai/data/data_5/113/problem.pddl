(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_1 grey_box_2 grey_box_1 green_box_1 - box
   purple_ball_1 blue_ball_1 yellow_ball_1 yellow_ball_2 - ball
 )
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (carrying yellow_ball_2)) (sometime (at_ blue_door_3)) (sometime (and (agentinroom room_3) (not (emptyhands)))) (sometime (or (carrying green_box_1) (agentinroom room_3))))
