(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (and (or (= ?room2 room_3) (and (agentinroom room_3) (not (= ?room1 room_3)))) (not (emptyhands))) (hold_3)) (when (or (carrying green_box_1) (= ?room2 room_3) (and (agentinroom room_3) (not (= ?room1 room_3)))) (hold_4)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (hold_0) (when (or (= ?obj yellow_ball_2) (carrying yellow_ball_2)) (hold_1)) (when (agentinroom room_3) (hold_3)) (when (or (= ?obj green_box_1) (carrying green_box_1) (agentinroom room_3)) (hold_4)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (carrying yellow_ball_2) (not (= ?obj yellow_ball_2))) (hold_1)) (when (or (and (carrying green_box_1) (not (= ?obj green_box_1))) (agentinroom room_3)) (hold_4)) (increase (total-cost) 1)))
 (:action toggle
