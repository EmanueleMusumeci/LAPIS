(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_ball_1 grey_ball_1 red_ball_1 grey_ball_3 grey_ball_2 yellow_ball_1 - ball
 )
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (not (emptyhands))) (always (locked blue_door_1)) (sometime (at_ grey_door_1)) (sometime-before (at_ grey_door_1) (at_ blue_box_1)) (sometime (not (emptyhands))) (sometime (or (not (emptyhands)) (at_ red_ball_1))))
