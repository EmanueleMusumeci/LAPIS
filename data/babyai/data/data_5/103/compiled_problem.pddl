(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_1 - box
   purple_ball_1 grey_ball_1 grey_ball_3 grey_ball_2 yellow_ball_1 - ball
 )
 ...
 (and (objectcolor ?d greytype) (adjacentrooms room_3 room_4 ?d) (at_ ?d) (not (locked ?d)))) (hold_0) (hold_2) (hold_4) (hold_5)))
