(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_door_1 yellow_door_1 red_door_1 purple_door_1 - door
   yellow_box_1 red_box_1 grey_box_1 red_box_2 - box
   blue_ball_2 blue_ball_1 green_ball_1 yellow_ball_1 - ball
 )
 ...
 (and (objectcolor ?d yellowtype) (adjacentrooms room_3 room_1 ?d) (at_ ?d) (not (locked ?d))))))
 (:constraints (sometime (not (emptyhands))) (always (not (agentinroom room_3))) (sometime (carrying red_box_1)) (always (locked purple_door_1)) (sometime (at_ yellow_door_1)) (sometime-before (at_ yellow_door_1) (not (emptyhands))))
