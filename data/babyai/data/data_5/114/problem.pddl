(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_ball_1 blue_ball_1 green_ball_1 yellow_ball_1 yellow_ball_2 - ball
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (not (locked yellow_door_1))) (always (locked red_door_1)) (sometime (or (not (locked yellow_door_1)) (carrying blue_ball_1))) (sometime (not (emptyhands))))
