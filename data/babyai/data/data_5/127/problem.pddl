(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_box_2 grey_box_1 blue_box_3 purple_box_1 blue_box_1 - box
   green_ball_1 blue_ball_1 yellow_ball_1 - ball
 )
 ...
 (:constraints (sometime (or (objectinroom purple_box_1 room_3) (not (locked yellow_door_1)))) (sometime (agentinroom room_4)) (sometime (or (at_ green_door_1) (carrying blue_ball_1))) (sometime (or (objectinroom green_ball_1 room_3) (not (emptyhands)))) (sometime (agentinroom room_2)))
