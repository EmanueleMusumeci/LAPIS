(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_box_2 green_box_1 yellow_box_1 yellow_box_2 grey_box_1 - box
 ...
 (:constraints (sometime (or (not (locked purple_door_1)) (at_ purple_door_1))) (sometime (and (not (emptyhands)) (carrying yellow_box_2))) (sometime (at_ yellow_ball_1)))
