(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   green_box_2 green_box_1 yellow_box_1 grey_box_1 - box
   blue_ball_1 blue_ball_2 - ball
 )
 ...
 (and (objectcolor ?v greytype) (objectinroom ?v room_3) (agentinroom room_3) (at_ ?v))) (hold_0) (hold_1) (hold_2)))
