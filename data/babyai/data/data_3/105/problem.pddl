(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_box_2 green_box_1 purple_box_1 yellow_box_1 - box
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (carrying purple_ball_1)) (sometime (locked green_door_1)) (sometime-after (locked green_door_1) (carrying purple_ball_1)) (sometime (or (at_ purple_ball_1) (objectinroom green_box_1 room_4))))
