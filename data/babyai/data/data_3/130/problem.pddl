(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_2 yellow_ball_1 blue_ball_1 green_ball_1 green_ball_2 red_ball_1 - ball
 ...
 (:constraints (sometime (at_ grey_door_1)) (sometime-after (at_ grey_door_1) (or (locked grey_door_1) (at_ green_box_1))) (always (not (agentinroom room_2))) (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (or (agentinroom room_4) (not (locked red_door_1)))))
