(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_2 yellow_ball_1 purple_ball_1 blue_ball_1 - ball
   green_box_1 grey_box_2 yellow_box_1 grey_box_1 - box
 )
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (carrying yellow_box_1)) (sometime (at_ blue_door_3)))
