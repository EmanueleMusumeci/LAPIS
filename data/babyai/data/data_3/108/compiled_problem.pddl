(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   yellow_door_1 green_door_2 red_door_1 - door
   purple_box_2 green_box_1 purple_box_1 grey_box_1 - box
   blue_ball_1 blue_ball_2 red_ball_1 - ball
 )
 ...
 (and (objectcolor ?v purpletype) (objectinroom ?v room_1) (agentinroom room_1) (at_ ?v))) (hold_0)))
