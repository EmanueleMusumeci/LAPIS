(define (domain liftedtcore_minigrid-domain)
 ...
 (:action drop
  ...
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (= ?obj blue_ball_3) (= ?room room_2)) (objectinroom blue_ball_3 room_2)) (hold_0)) (increase (total-cost) 1)))
 (:action toggle
