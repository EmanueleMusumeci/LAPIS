(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   grey_door_1 purple_door_1 - door
   yellow_ball_2 blue_ball_1 yellow_ball_1 green_ball_1 red_ball_1 - ball
   purple_box_1 blue_box_1 grey_box_1 - box
 )
 ...
 (and (objectcolor ?v purpletype) (objectinroom ?v room_1) (agentinroom room_1) (at_ ?v))) (hold_0) (hold_1)))
