(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_box_1 red_box_2 yellow_box_1 grey_box_1 - box
   yellow_ball_1 blue_ball_1 green_ball_1 blue_ball_2 - ball
 )
 ...
 (:constraints (sometime (not (emptyhands))) (always (not (agentinroom room_3))) (sometime (carrying yellow_ball_1)))
