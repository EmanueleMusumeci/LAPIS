(define (problem depot-problem)
  ...
  (:init
    ...
    ; container-0-0 is clear (no hoist occupying it, crate is ON it not a hoist)
    (clear container-0-0)
    ; depot48-1-1 is NOT listed as clear because hoist0 occupies it
    ; (closed-world assumption correctly treats it as not clear)
  )
