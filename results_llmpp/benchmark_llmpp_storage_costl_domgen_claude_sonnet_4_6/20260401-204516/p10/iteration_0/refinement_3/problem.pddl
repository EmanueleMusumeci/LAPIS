(define (problem depot-problem)
  ...
  (:objects
    ...
    depot48-1-1-surface depot48-1-2-surface depot48-1-3-surface depot48-1-4-surface - surface
  )
  ...
  (:goal
    (and
      ...
      (in depot48-1-2-surface depot48-1-2)
      (on crate2 depot48-1-3-surface)
      (in depot48-1-3-surface depot48-1-3)
      (on crate3 depot48-1-4-surface)
      (in depot48-1-4-surface depot48-1-4)
    )
  )
)