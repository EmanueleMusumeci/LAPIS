(define (problem depot-problem)
  ...
  (:init
    ...
    (crate-at crate2 container0)
    (crate-at crate3 container0)
    ...
    ;; Adjacency connections among depot storeareas (row1)
    ...
    ;; Adjacency connections among depot storeareas (row2)
    ...
    ;; Adjacency connections between row1 and row2
  ...
  (:goal
    (and
      ...
      (crate-at crate2 depot48)
      (crate-at crate3 depot48)
    )
  )
)