(define (problem depot-problem)
  ...
  (:init
    ...
    ; No storeareas are clear initially — consistent with all areas
    ; being occupied by hoists or crates.
    ; The go-out action will clear a storearea when a hoist leaves it,
    ; enabling subsequent move and drop actions.
  )
