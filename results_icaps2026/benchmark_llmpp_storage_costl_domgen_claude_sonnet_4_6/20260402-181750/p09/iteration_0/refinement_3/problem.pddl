(define (problem depot-problem)
  ...
  (:init
    ...
    ;; Clear storeareas (areas without hoists or crates)
    ;; depot48-2-1 is NOT clear because hoist0 is there
    ;; depot48-1-2 is NOT clear because hoist1 is there
    ;; depot48-1-3 is NOT clear because hoist2 is there
    (clear depot48-2-2)
    (clear depot48-2-3)
    (clear depot48-2-4)
    (clear depot48-1-1)
