(define (problem depot-problem)
  ...
  (:init
    ...
    ; Crates at places
    (crate_at_place crate0 container0)
    (crate_at_place crate1 container0)
    (crate_at_place crate2 container0)
    ...
    ; Depot adjacency connections (horizontal and vertical)
  ...
  (:goal
    (and
      (crate_at_place crate0 depot48)
      (crate_at_place crate1 depot48)
      (crate_at_place crate2 depot48)
    )
  )
)