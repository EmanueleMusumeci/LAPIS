(define (problem tyreworld-problem)
  ...
  (:objects
    ...
    flat1 flat2 flat3 flat4 flat5 flat6 flat7 flat8 flat9 flat10 flat11 flat12 flat13 flat14 - wheel
    intact1 intact2 intact3 intact4 intact5 intact6 intact7 intact8 intact9 intact10 intact11 intact12 intact13 intact14 - wheel
  )
  ...
  (:goal
    (and
      ...
      ; flat tyres, wrench, jack, and pump in the boot
      (in flat1 boot)
      (in flat2 boot)
      (in flat3 boot)
      (in flat4 boot)
