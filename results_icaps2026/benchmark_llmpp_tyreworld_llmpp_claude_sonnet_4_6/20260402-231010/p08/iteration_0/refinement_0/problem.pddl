(define (problem tyreworld-problem)
  ...
  (:objects
    ...
    flat1 flat2 flat3 flat4 flat5 flat6 flat7 flat8 - wheel
    intact1 intact2 intact3 intact4 intact5 intact6 intact7 intact8 - wheel
  )
  ...
  (:init
    ...
    ; Tools and intact tyres in boot
    (in jack boot)
    (in pump boot)
    (in wrench boot)
    (in intact1 boot)
