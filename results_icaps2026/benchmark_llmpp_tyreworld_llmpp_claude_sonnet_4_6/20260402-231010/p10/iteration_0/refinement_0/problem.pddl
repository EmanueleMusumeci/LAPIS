(define (problem tyreworld-problem)
  ...
  (:objects
    ...
    flat1 flat2 flat3 flat4 flat5 flat6 flat7 flat8 flat9 flat10 - wheel
    intact1 intact2 intact3 intact4 intact5 intact6 intact7 intact8 intact9 intact10 - wheel
  )
  ...
  (:init
    ...
    ; Intact tyres in boot, not inflated, intact
    (in intact1 boot)
    (in intact2 boot)
    (in intact3 boot)
    (in intact4 boot)
