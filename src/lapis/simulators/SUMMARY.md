...
I've created a complete simulator infrastructure for LAPIS with the following components:
...
### 4. Clear Separation
- Simulators in `/DATA/LAPIS/simulators/`
