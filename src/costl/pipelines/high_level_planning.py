...
try:
    ...
    print("Warning: Could not import High_Level_Planner. Make sure src/costl/planner/high/Planner is in PYTHONPATH.")
...
class HighLevelPlanningPipeline(BasePipeline):
    def __init__(self, domain_name, num_constraints, max_attempts=5, **base_init_kwargs):
        ...
        # High_Level_Planner is now at src/costl/planner/high
