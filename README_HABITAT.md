...
**Environment**: `/DATA/LAPIS/.conda_env/`  
**Python**: 3.9.25  
**Habitat-sim**: 0.3.3  
**Size**: 2.7 GB
...
✓ All LAPIS dependencies (pddl, dotmap, gymnasium, numpy)  
...
# Or full path
conda activate /DATA/LAPIS/.conda_env
```
...
### Use in Code
```python
# Activate: conda activate /DATA/LAPIS/.conda_env
import sys
sys.path.insert(0, '/DATA/LAPIS/src')

from lapis.simulators.habitat_simulator import HabitatSimulator
